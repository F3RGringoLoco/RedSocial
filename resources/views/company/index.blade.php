                        ...
                        <div class="collapse" id="neg-data">
                            <div class="col p-4 rounded bg-light" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                ...
                                <div class="d-grid gap-2 col-4 mx-auto">
                                    <a class="btn btn-outline-dark" href="{{route('brand.create')}}"><i class="fas fa-plus"></i> Añadir</a>
                                </div>
                            </div> 
                        </div>
            ...
            <div class="col-md-8">
                <div class="card ">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted">Unico requisito es que seas propietario o dueño</p>
...
<div class="modal fade" id="memberModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn btn-outline-dark" href="{{route('member.create')}}"><i class="fas fa-user-plus"></i> Añadir Miembro</a>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
            </div>
        </div>
    </div>
